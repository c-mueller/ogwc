...
func init() {
	...
	file2 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1541894720, 0),
	...
	file3 := &embedded.EmbeddedFile{
		Filename:    "ipm_cost.json",
		FileModTime: time.Unix(1541897021, 0),
		Content:     string("{\n  \"metal\": 12500,\n  \"crystal\": 2500,\n  \"deuterium\": 10000\n}"),
	}
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1541897021, 0),
